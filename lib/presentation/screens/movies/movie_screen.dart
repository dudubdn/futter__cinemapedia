    ...
    return Scaffold(
      body: CustomScrollView(
        ...
        slivers: [
          ...
          SliverList(
              delegate:
                  SliverChildBuilderDelegate((context, index) => _CustomMovieDetails(movie: movie), childCount: 1))
        ],
      ),
    );
  }
    ...
    return SliverAppBar(
      actions: [
        Container(
          ...
          child: IconButton(
            onPressed: () async {
              // ref.read(localStorageRepositoryProvider).toggleFavorite(movie).then(
